...
# ==============================================================================
# 🎮 LÓGICA DE FLUJO: JUEGO O PANEL
# ==============================================================================

if st.session_state.dungeon_stage != 'unlocked':
    # Si no han ganado, mostramos la mazmorra
    render_dungeon()
else:
    # ==========================================================================
    # 🛠️ ZONA SEGURA: EL PANEL REAL
    # ==========================================================================
    ...
    if not check_submitted or secret_pass != real_admin_pass:
        if check_submitted: st.error("Contraseña incorrecta.")
        st.info("Introduce la contraseña que acabas de ganar.")
        st.stop() 
